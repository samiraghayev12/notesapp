            ...
            public void onClick(View v) {
                ...
                if(newtitle != null || newcontent != null) {
                    DocumentReference documentReference=firebaseFirestore.collection
                            ("notes").document(firebaseUser.getUid()).
                            collection("myNotes").
                    ...
                    documentReference.set(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(getApplicationContext(), "Qeydiniz yeniləndi❤"
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(getApplicationContext()," Yeniləmə uğursuz oldu🙄!",Toast.LENGTH_SHORT).show();
                            onStop();
